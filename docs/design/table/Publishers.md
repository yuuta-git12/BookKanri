...
| --- | --- | --- | --- | ---------- | ------ | --------- | --- | -------- | ------ | -------------- | --------------- |
| 1   | ○   |     |     | id         | 出版社ID  | BIGINT    | -   | ○        |        | AUTO INCREMENT |                 |
| 2   |     | ○   |     | user_id    | ユーザーID | BIGINT    | -   | ○        |        |                |                 |
| 3   |     |     |     | name       | 出版社名   | VARCHAR   | 255 | ○        |        |                | user_id と複合ユニーク |
...
| --- | ------------------------------ | ------------- | ---- | --------------- |
| 1   | publishers_user_id_name_unique | user_id, name | ○    | ユーザーごとに同名出版社を禁止 |
